...
const TelecelBundleCards = () => {
  ...
  const fetchNetworkAvailability = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        // If Telecel is out of stock, show message in modal
  ...
  const bundles = [
    ...
    { capacity: '15', mb: '15000', price: '71.0', network: 'TELECEL' },
    { capacity: '20', mb: '20000', price: '90.00', network: 'TELECEL' },
    { capacity: '25', mb: '25000', price: '112.0', network: 'TELECEL' },
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-sm w-full overflow-hidden animate-fadeIn">
          {/* Header */}
          <div className="bg-red-600 dark:bg-red-700 p-3">
          ...
          <div className="p-4">
            ...
            <div className="flex justify-between space-x-3">
              ...
              <button
                ...
                className="flex-1 px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 focus:outline-none disabled:bg-red-400 disabled:cursor-not-allowed transition-colors font-medium shadow-sm text-sm"
                disabled={isLoading}
              >
                {isLoading ? (
